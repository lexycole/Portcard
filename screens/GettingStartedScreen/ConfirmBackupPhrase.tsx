...
export default function ConfirmBackupPhrase({ navigation }: RootStackScreenProps<'ConfirmBackupPhrase'>) {
    ...
    return (
        ...
        <MainContainer style={{ backgroundColor: "#242326" }}>
            ...
            <View style={tw`mb-[36px] border border-dashed border-2 border-lime-900 rounded-[8px] bg-[#242326] mx-[16px]`}>
                {/* Cold -  Secure - Activity - Discord ROW*/}
                <View style={tw`flex-row items-center justify-between bg-[#242326] mt-[25px] mb-[24px] pl-[34px] pr-[35px]`}>
                    ...
                    <View style={tw`flex-row items-center bg-[#242326]`}>
                        <Text style={[tw`text-[#A2A1A2] text-[16px]`, { fontFamily: 'Rubik_400Regular' }]}>Cold</Text>
                    </View>
                    {/* Secure Text */}
                    <View style={tw`flex-row items-center bg-[#242326]`}>
                    ...
                    {/* Activity Text */}
                    <View style={tw`flex-row items-center bg-[#242326]`}>
                        <Text style={[tw`text-[#A2A1A2] text-[16px]`, , { fontFamily: 'Rubik_400Regular' }]}>Activity</Text>
                    </View>
                    {/* Discord Text */}
                    <View style={tw`flex-row items-center bg-[#242326]`}>
                ...
                <View style={tw`flex-row items-center justify-between bg-[#242326] mb-[24px] pl-[34px] pr-[35px]`}>
                    {/* Indoor Text */}
                    <View style={tw`flex-row items-center bg-[#242326]`}>
                        <Text style={[tw`text-[#A2A1A2] text-[16px]`, { fontFamily: 'Rubik_400Regular' }]}>Indoor</Text>
                    </View>
                    {/* Secure Text */}
                    <View style={tw`flex-row items-center bg-[#242326]`}>
                        <Text style={[tw`text-[#A2A1A2] text-[16px]`, { fontFamily: 'Rubik_400Regular' }]}>Secure</Text>
            ...
            <TouchableOpacity
                onPress={() => navigation.navigate("ConfirmBackupPhraseTwo")}

...
export default function ConfirmBackupPhraseThree({ navigation }: RootStackScreenProps<'ConfirmBackupPhraseThree'>) {
    ...
    // Renders Confirm Backup Phrase Three
    return (
        // Main Container
        <MainContainer style={{ backgroundColor: "#242326" }}>
            ...
            <TouchableOpacity
                onPress={() => navigation.navigate("ConfirmBackupPhraseFour")}

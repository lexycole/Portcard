/**
 *  ProcessingAssetsWithdrawal.tsx
 * 
...
export default function ProcessingAssetsWithdrawal({ navigation }: RootStackScreenProps<'ProcessingAssetsWithdrawal'>) {
  ...
  // Processing Assets Withdrawal Renders
  return (
    <MainContainer style={{ backgroundColor: "#242326" }}>
      ...
      <TouchableOpacity
        ...
        style={tw`w-full h-24 left-[16px] top-[52px]`}>

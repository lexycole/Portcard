...
const WithdarwAssetUsdtSelectList = () => {
  ...
  return (
    <SelectList
      ...
      style={{ backgroundColor: '#2F2E32', borderColor:"#2F2E32", borderRadius: 8, paddingVertical: 18, marginTop:6,marginHorizontal:15 }}
...
export default WithdarwAssetUsdtSelectList;